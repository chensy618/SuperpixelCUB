...
base_path = 'mnt/d/Github/SuperpixelCUB/VLPart'
...
def add_vlpart_config(cfg):
    ...
    cfg.DINO.BASEDATA_SAVE_DIR = base_path + '/output_basedata'
    # cfg.DINO.BASEDATA_ANN_PATH = 'datasets/pascal_part/train_base_one.json'
    cfg.DINO.BASEDATA_ANN_PATH = base_path + '/datasets/pascal_part/train_base_one.json'
    # cfg.DINO.BASEDATA_IMS_PATH = 'datasets/pascal_part/VOCdevkit/VOC2010/JPEGImages/'
    cfg.DINO.BASEDATA_IMS_PATH = base_path + '/datasets/pascal_part/VOCdevkit/VOC2010/JPEGImages/'
    ...
    cfg.OUTPUT_ANN_DIR = base_path + '/datasets/grouping.json'
    ...
    cfg.MODEL.ROI_BOX_HEAD.CAT_FREQ_PATH_GROUP = [base_path + '/datasets/metadata/lvis_v1_train_cat_info.json']
    ...
    cfg.MODEL.ROI_BOX_HEAD.ZEROSHOT_WEIGHT_PATH = base_path + '/datasets/metadata/lvis_v1_clip_a+cname.npy'
    # cfg.MODEL.ROI_BOX_HEAD.ZEROSHOT_WEIGHT_PATH_GROUP = ['datasets/metadata/lvis_v1_clip_a+cname.npy']
    cfg.MODEL.ROI_BOX_HEAD.ZEROSHOT_WEIGHT_PATH_GROUP = [base_path + '/datasets/metadata/lvis_v1_clip_a+cname.npy']
    # cfg.MODEL.ROI_BOX_HEAD.ZEROSHOT_WEIGHT_INFERENCE_PATH = 'datasets/metadata/lvis_v1_clip_a+cname.npy'
    cfg.MODEL.ROI_BOX_HEAD.ZEROSHOT_WEIGHT_INFERENCE_PATH = base_path + '/datasets/metadata/lvis_v1_clip_a+cname.npy'
    ...
    cfg.MODEL.ROI_BOX_HEAD.CAT_FREQ_PATH = base_path + '/datasets/metadata/lvis_v1_train_cat_info.json'
    ...
    cfg.DATALOADER.TARFILE_PATH = base_path + '/datasets/imagenet/metadata-22k/tar_files.npy'
    # cfg.DATALOADER.TAR_INDEX_DIR = 'datasets/imagenet/metadata-22k/tarindex_npy'
    cfg.DATALOADER.TAR_INDEX_DIR = base_path + '/datasets/imagenet/metadata-22k/tarindex_npy'
